...
class PetController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->textarea('previous_problems', __('Previous problems'));
        $form->textarea('drug_allergies', __('Drug allergies'));
        $form->textarea('current_diet', __('Current diet'));
        $form->textarea('current_medication', __('Current medication'));
